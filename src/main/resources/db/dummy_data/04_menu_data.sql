...
values (now(), now(), date('2024-07-29'), date('2024-08-02'), 1, 1),
       ...
       (now(), now(), date('2024-08-06'), date('2024-08-09'), 1, 6),
       (now(), now(), date('2024-08-06'), date('2024-08-09'), 2, 7),
       (now(), now(), date('2024-08-06'), date('2024-08-09'), 3, 8),
       (now(), now(), date('2024-08-06'), date('2024-08-09'), 4, 9),
       (now(), now(), date('2024-08-06'), date('2024-08-09'), 5, 10);